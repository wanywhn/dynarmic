...
class A32EmitLoongArch64 final : public EmitLoongArch64 {
public:
    A32EmitLoongArch64(BlockOfCode& code, A32::UserConfig conf, A32::Jit* jit_interface);
    ~A32EmitLoongArch64() override;
