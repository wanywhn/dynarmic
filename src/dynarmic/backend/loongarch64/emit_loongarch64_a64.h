...
class A64EmitLoongArch64 final : public EmitLoongArch64 {
public:
    A64EmitLoongArch64(BlockOfCode& code, A64::UserConfig conf, A64::Jit* jit_interface);
    ~A64EmitLoongArch64() override;
