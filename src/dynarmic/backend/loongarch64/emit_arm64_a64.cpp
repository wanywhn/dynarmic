...
void EmitA64Terminal(Xbyak_loongarch64::CodeGenerator&, EmitContext&, IR::Term::Interpret, IR::LocationDescriptor, bool) {
    ASSERT_FALSE("Interpret should never be emitted.");
}

void EmitA64Terminal(Xbyak_loongarch64::CodeGenerator& code, EmitContext& ctx, IR::Term::ReturnToDispatch, IR::LocationDescriptor, bool) {
    EmitRelocation(code, ctx, LinkTarget::ReturnToDispatcher);
}

void EmitA64Terminal(Xbyak_loongarch64::CodeGenerator& code, EmitContext& ctx, IR::Term::LinkBlock terminal, IR::LocationDescriptor, bool is_single_step) {
...
void EmitA64Terminal(Xbyak_loongarch64::CodeGenerator& code, EmitContext& ctx, IR::Term::LinkBlockFast terminal, IR::LocationDescriptor, bool is_single_step) {
    if (ctx.conf.HasOptimization(OptimizationFlag::BlockLinking) && !is_single_step) {
        EmitBlockLinkRelocation(code, ctx, terminal.next, BlockRelocationType::Branch);
    }
...
void EmitA64Terminal(Xbyak_loongarch64::CodeGenerator& code, EmitContext& ctx, IR::Term::PopRSBHint, IR::LocationDescriptor, bool is_single_step) {
...
void EmitA64Terminal(Xbyak_loongarch64::CodeGenerator& code, EmitContext& ctx, IR::Term::FastDispatchHint, IR::LocationDescriptor, bool) {
    EmitRelocation(code, ctx, LinkTarget::ReturnToDispatcher);

    // TODO: Implement FastDispatchHint optimization
}

void EmitA64Terminal(Xbyak_loongarch64::CodeGenerator& code, EmitContext& ctx, IR::Term::If terminal, IR::LocationDescriptor initial_location, bool is_single_step) {
...
template<>
void EmitIR<IR::Opcode::A64CallSupervisor>(Xbyak_loongarch64::CodeGenerator& code, EmitContext& ctx, IR::Inst* inst) {
    auto args = ctx.reg_alloc.GetArgumentInfo(inst);
...
template<>
void EmitIR<IR::Opcode::A64ExceptionRaised>(Xbyak_loongarch64::CodeGenerator& code, EmitContext& ctx, IR::Inst* inst) {
    auto args = ctx.reg_alloc.GetArgumentInfo(inst);
    ctx.reg_alloc.PrepareForCall();
...
template<>
void EmitIR<IR::Opcode::A64DataCacheOperationRaised>(Xbyak_loongarch64::CodeGenerator& code, EmitContext& ctx, IR::Inst* inst) {
    auto args = ctx.reg_alloc.GetArgumentInfo(inst);
...
template<>
void EmitIR<IR::Opcode::A64InstructionCacheOperationRaised>(Xbyak_loongarch64::CodeGenerator& code, EmitContext& ctx, IR::Inst* inst) {
    auto args = ctx.reg_alloc.GetArgumentInfo(inst);
...
template<>
void EmitIR<IR::Opcode::A64InstructionSynchronizationBarrier>(Xbyak_loongarch64::CodeGenerator& code, EmitContext& ctx, IR::Inst*) {
...
void EmitIR<IR::Opcode::A64GetCNTFRQ>(Xbyak_loongarch64::CodeGenerator& code, EmitContext& ctx, IR::Inst* inst) {
    ...
    RegAlloc::Realize(Xvalue);
    code.add_d(Xvalue, ctx.conf.cntfreq_el0, code.zero);
}
...
void EmitIR<IR::Opcode::A64GetCTR>(Xbyak_loongarch64::CodeGenerator& code, EmitContext& ctx, IR::Inst* inst) {
    ...
    RegAlloc::Realize(Wvalue);
    code.add_d(Wvalue, ctx.conf.ctr_el0, code.zero);
}
...
void EmitIR<IR::Opcode::A64GetDCZID>(Xbyak_loongarch64::CodeGenerator& code, EmitContext& ctx, IR::Inst* inst) {
    auto Wvalue = ctx.reg_alloc.WriteW(inst);
    RegAlloc::Realize(Wvalue);
    code.add_d(Wvalue, ctx.conf.dczid_el0, code.zero);
}
