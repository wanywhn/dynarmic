 ...
 */
    ...
    u32 A32JitState::Cpsr() const {
        ...
        // NZCV flags
        cpsr |= NZCV::FromLoongArch64(cpsr_nzcv);
        // Q flag
        cpsr |= cpsr_q ? 1 << 27 : 0;
        // GE flags
    ...
    void A32JitState::SetCpsr(u32 cpsr) {
        // NZCV flags
        cpsr_nzcv = NZCV::ToLoongArch64(cpsr);
        // Q flag
...
// NZCV; QC (ASIMD only), AHP; DN, FZ, RMode, Stride; SBZP; Len; trap enables; cumulative bits
    ...
    void A32JitState::SetFpscr(u32 FPSCR) {
        ...
        fpsr = FPSCR & FPSCR_MODE_MASK;
        upper_location_descriptor = (upper_location_descriptor & 0x0000'ffff) | (FPSCR & FPSCR_MODE_MASK);
        return;
