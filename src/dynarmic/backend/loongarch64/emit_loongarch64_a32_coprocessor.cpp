...
namespace Dynarmic::Backend::LoongArch64 {
    ...
    static void CallCoprocCallback(BlockOfCode &code, EmitContext &ctx, A32::Coprocessor::Callback callback,
                                   IR::Inst *inst = nullptr, std::optional<Argument::copyable_reference> arg0 = {},
