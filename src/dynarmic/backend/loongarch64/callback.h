...
using RegList = std::vector<Xbyak_loongarch64::Reg64>;
...
public:
    ...
    virtual void EmitCallWithReturnPointer(BlockOfCode& code, std::function<void(Xbyak_loongarch64::Reg64, RegList)> fn) const = 0;
};
...
public:
    ...
    void EmitCallWithReturnPointer(BlockOfCode& code, std::function<void(Xbyak_loongarch64::Reg64, RegList)> fn) const override;
