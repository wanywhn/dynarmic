...
void SimpleCallback::EmitCallWithReturnPointer(BlockOfCode& code, std::function<void(Xbyak_loongarch64::Reg64, RegList)> l) const {
    l(code.ABI_PARAM1, {code.ABI_PARAM2, code.ABI_PARAM3, code.ABI_PARAM4});
    code.CallFunction(fn);
}
...
void ArgCallback::EmitCallWithReturnPointer(BlockOfCode& code, std::function<void(Xbyak_loongarch64::Reg64, RegList)> l) const {
