...
//using CodePtr = const void*;
    ...
    struct EmitConfig {
        ...
        void
        (*emit_check_memory_abort)(BlockOfCode &code, EmitContext &ctx, IR::Inst *inst, Xbyak_loongarch64::Label &end);
    ...
    EmittedBlockInfo
    EmitArm64(BlockOfCode &code, IR::Block block, const EmitConfig &emit_conf, FastmemManager &fastmem_manager);
