...
#    pragma warning(disable : 4324)  // Structure was padded due to alignment specifier
    ...
    struct A64JitState {
        ...
        u32 GetPstate() const {
            return NZCV::FromLoongArch64(cpsr_nzcv);
        }

        void SetPstate(u32 new_pstate) {
            cpsr_nzcv = NZCV::ToLoongArch64(new_pstate);
        }
        ...
        u64 GetUniqueHash() const noexcept {
            const u64 fpcr_u64 =
                    static_cast<u64>(fpcr & A64::LocationDescriptor::fpcr_mask) << A64::LocationDescriptor::fpcr_shift;
